...
if(isset($msg)) {
	switch($msg) {
		...
		case "E03": echo '<div class="alert alert-danger">'.$xButton.'<i class="glyphicon glyphicon-exclamation-sign"></i> <b>Domain nicht hinzugefügt oder bearbeitet!</b> Der angegebene Pfad existiert nicht.</div>'; break;
